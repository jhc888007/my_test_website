...
description: 面向零技术用户，把任意网站 demo 需求拆成产品需求、设计需求、技术需求三份文档，并配合 GitHub 与 Vercel / 微信小程序 直接上线部署
---
...
**若用户选择【网站网页】：**
  ...
  - **核心流程**：包含注册/登录等，但**因为只是demo，所以尽可能降低复杂度，询问用户是否可以用明文存储密码**，如果可以明确写到技术文档中。
